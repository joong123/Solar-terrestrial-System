...
//字符信息
UINTuChar;//字体编码
CD3DSpriteD3DSprite;//字体精灵
 
//输出位置
CSizeSizeCell;//单元大小
CSizeSizeFont;//字体大小
CPointPointOrigin;//原点位置
...
//配置变量
protected:
UINTm_uGrayLevel;//灰度等级
UINTm_uMaxBufferCount;//缓冲数目
 
//字体对象
protected:
CFontm_Font;//字体对象
TEXTMETRICm_TextMetric;//字体属性
 
//内核对象
protected:
CD3DFontItemPtrMapm_FontItemPtrMap;//字体索引
CD3DFontItemPtrArraym_FontItemPtrActive;//字体数组
